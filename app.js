...
function renderSetup() {
  ...
  const classOptions = classes.map(item => `<div class="pill">${item.className}</div>`).join("");
    ...
    sectionContent = `
      <div class="setup-grid">
        ...
        <div class="panel stack setup-card">
          <div class="section-head">
            <h3>Add Class</h3>
            <div class="muted">Create the classes students can be assigned to.</div>
          </div>
          <div class="form-grid">
        ...
        <div class="panel stack setup-card setup-card-wide">
          ...
          ${classes.length ? renderTable(
            ...
            classes.map(item => [
              item.className,
              `<div class="actions-row">
                <button class="danger" onclick="handleDeleteClass('${item.classId}')">Delete</button>
              </div>`
            ])
...
function handleSetupSection(section) {
